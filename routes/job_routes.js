...
router
  .route('/')
  .get(isLoggedIn, catchAsync(job_controller.job_index_get))
  .post(isLoggedIn, catchAsync(job_controller.job_create_post));
...
router
  .route('/:jobId/update')
  .get(isLoggedIn, catchAsync(job_controller.job_update_get));
